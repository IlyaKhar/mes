...
function getWorkloadDotClassName(taskCount: number) {
  if (taskCount >= 6) return "bg-primary shadow-[0_0_18px_rgba(0,87,255,0.7)]";
  if (taskCount >= 3) return "bg-primary/75 shadow-[0_0_12px_rgba(0,87,255,0.42)]";
      ...
      >
        {focusedTask ? (
          <article className="relative w-full max-w-[720px] overflow-hidden rounded-default bg-white p-8 shadow-float ring-1 ring-border">
            <div className="absolute inset-x-12 top-0 h-1 rounded-b-full bg-primary shadow-[0_0_34px_rgba(0,87,255,0.85)]" />
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_260px]">
              ...
              <div className="flex flex-col items-center justify-center rounded-default bg-primary p-6 text-white shadow-[0_0_60px_rgba(0,87,255,0.42)]">
